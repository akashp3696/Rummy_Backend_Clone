const calculatePlayerScore = (playerCards, jokerRank) => {
    const pureSequences = [];
...
const isImpureSequence = (sequence, specialJokerRank) => {
    ...
    if (normalSequence[0].rank == "A" && normalSequence.find(card => ranks.indexOf(card.rank) >= normalSequence.length + jokerSequence.length) != undefined) {
...
//     [{ suit: 'diamonds', rank: '6' }, { suit: 'diamonds', rank: 'K' }, { suit: 'diamonds', rank: 'K' }], 
//     [{ suit: 'diamonds', rank: 'K' }, { suit: 'diamonds', rank: 'K' }, { suit: 'diamonds', rank: 'J' }, { suit: 'hearts', rank: 'J' }]
// ];

// const test2 = [
//     [{ suit: 'hearts', rank: 'A' }, { suit: 'hearts', rank: '2' }, { suit: 'hearts', rank: '3' }], 
//     [{ suit: 'hearts', rank: 'A' }, { suit: 'hearts', rank: '2' }, { suit: 'hearts', rank: '3' }, { suit: 'hearts', rank: '4' }], 
//     [{ suit: 'hearts', rank: 'A' }, { suit: 'hearts', rank: '2' }, { suit: 'hearts', rank: '3' }, { suit: 'hearts', rank: '4' }, { suit: 'hearts', rank: '5' }], 
//     [{ suit: 'hearts', rank: 'A' }, { suit: 'hearts', rank: 'K' }, { suit: 'hearts', rank: 'Q' }], 
//     [{ suit: 'hearts', rank: 'A' }, { suit: 'hearts', rank: 'K' }, { suit: 'hearts', rank: 'Q' }, { suit: 'hearts', rank: 'J' }], 
//     [{ suit: 'diamonds', rank: '6' }, { suit: 'diamonds', rank: 'K' }, { suit: 'diamonds', rank: 'K' }], 
//     [{ suit: 'diamonds', rank: 'K' }, { suit: 'diamonds', rank: 'K' }, { suit: 'diamonds', rank: 'J' }, { suit: 'hearts', rank: 'J' }], 
//     [{ suit: 'diamonds', rank: 'A' }, { suit: 'diamonds', rank: '2' }, { suit: 'diamonds', rank: '3' }, { suit: 'hearts', rank: '3' }, { suit: 'spades', rank: '3' }], 
//     [{ suit: 'hearts', rank: 'A' }, { suit: 'hearts', rank: '2' }, { suit: 'hearts', rank: '3' }, { suit: 'hearts', rank: 'J' }, { suit: 'hearts', rank: 'Q' }], 
//     [{ suit: 'hearts', rank: 'A' }, { suit: 'hearts', rank: '2' }, { suit: 'hearts', rank: '3' }, { suit: 'hearts', rank: '4' }, { suit: 'hearts', rank: 'J' }, { suit: 'hearts', rank: 'Q' }], 
//     [{ suit: 'hearts', rank: 'A' }, { suit: 'hearts', rank: '2' }, { suit: 'hearts', rank: '3' }, { suit: 'hearts', rank: '4' }, { suit: 'hearts', rank: '5' }, { suit: 'hearts', rank: 'J' }, { suit: 'hearts', rank: 'Q' }], 
//     [{ suit: 'hearts', rank: 'A' }, { suit: 'hearts', rank: 'K' }, { suit: 'hearts', rank: 'Q' }, { suit: 'hearts', rank: 'J' }, { suit: 'hearts', rank: '10' }, { suit: 'hearts', rank: '9' }, { suit: 'hearts', rank: '8' }], 
//     [{ suit: 'hearts', rank: 'A' }, { suit: 'hearts', rank: 'K' }, { suit: 'hearts', rank: 'Q' }, { suit: 'hearts', rank: 'J' }, { suit: 'hearts', rank: '10' }, { suit: 'hearts', rank: '9' }, { suit: 'hearts', rank: '8' }, { suit: 'hearts', rank: '7' }], 
// ];

// console.log("Test 1:");
// console.log(calculatePlayerScore(test1, "K"));
// console.log("\nTest 2:");
// console.log(calculatePlayerScore(test2, "K"));
