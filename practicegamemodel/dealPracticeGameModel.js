...
const DealSchema = new Schema({
    ...
    point: { type: Number },
    tableType: { type: String, enum: ["1_deal", "2_deal", "3_deal"] },
...
// const Player = mongoose.model('DealPlayer', PlayerSchema);
// const Sequence = mongoose.model('Sequence', SequenceSchema);
// const Set = mongoose.model('Set', SetSchema);
const Deal = mongoose.model('DealPractice', DealSchema);
